        ...
        <Container fluid>
            <Row className="g-3">
                ...
                <Col xs={12} lg={3} className="bg-white p-5 m-3">
                    <img src="https://www.sellwise.pl/wp-content/uploads/2021/10/cudzyslow.png" alt="cudzysłów" />
                    <p>
                    Jeśli szukasz połączenia wiedzy i konkretnych rozwiązań zwiększających efektywność działań sprzedażowych jak i samą sprzedaż – lepiej trafić nie mogłeś.</p>
                    <br /><br />
                    <h6>
                        Dawid Kowalski <br />
                        <small>CEO w ...</small>
        ...
        <Container fluid>
            <Row className="g-3">
                <Col xs={12} lg={3} className="bg-white p-5 m-3">
                    <img src="https://www.sellwise.pl/wp-content/uploads/2021/10/cudzyslow.png" alt="cudzysłów" />
                    <p>
                    Szkolenie bardzo rzeczowe, mocno osadzone w realiach, świetne analizy procesu zakupu i wartości dodanych. Bardzo dobry, bezpośredni kontakt z uczestnikami szkolenia.</p>
                    <br /><br />
                    <h6>
                        Jan Kowalski <br />
                        <small>Dyrektor w ...</small>
...
export default RekrutacjaCarousel;